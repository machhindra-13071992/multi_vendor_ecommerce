    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <a class="btn btn-info" href="{{ route('brands.index') }}"> <i class="fa fa-arrow-circle-left"></i> Back To Listing </a>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-12 ml-auto mr-auto">
                                {!! Form::model($brands, ['id'=>'form-validation','novalidate'=>"novalidate",'enctype'=>"multipart/form-data",'method' => 'PATCH','route' => ['brands.update', $brands->id]]) !!}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group required">
                                                {!! Form::Label('name', 'Brand') !!}
                                                {!! Form::hidden('id', $brands->id, [ ]); !!}
                                                {!! Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Brand', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<?php  if(!isset($brands['image_file'])) {?>  <?php  } ?> >
											</div>
										</div>
										<div class="col-md-4">  
										<?php  if(isset($brands['image_file'])  && !empty($brands['image_file'])) {?>
											<img style="width:50%" src="{{ secure_asset('/storage/app/category_image_files/') }}/<?php echo $brands['image_file']; ?>">
										<?php  }?>
										</div>
                                    </div>
                                    <div class="row">
