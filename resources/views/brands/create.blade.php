                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-12 ml-auto mr-auto">
                                {!! Form::open(['route' => 'brands.store', 'method' => 'POST', 'role'=>'form','enctype'=>"multipart/form-data",'id'=>'form-validation', 'novalidate'=>"novalidate"]) !!}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group required">
                                                {!! Form::Label('name', 'Brands') !!}
                                                {!! Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Brands', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
									<div class="row">
										...
										<?php  if(isset($brands['image_file'])  && !empty($brands['image_file'])) {?>
											<img style="width:50%" src="{{ secure_asset('/storage/app/brand_image_files/') }}/<?php echo $brands['image_file']; ?>">
										<?php  }?>
										</div>
                                    </div>
                                    <div class="row">
