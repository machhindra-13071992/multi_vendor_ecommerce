            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        {!! Form::open(['route' => 'vendors.store','class'=>'form-horizontal mrg-top-40 pdd-right-30','method' => 'POST', 'role'=>'form', 'id'=>'form-validation', 'novalidate'=>"novalidate"]) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    {!! Form::email('email', null, array('placeholder' => 'Enter Email', 'class' => 'form-control', 'required')) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="form-1-3" class="col-md-2 control-label">Mobile</label>
                                <div class="col-md-10">
                                    {!! Form::text('mobile_no', null, array('placeholder' => 'Contact Number', 'class' => 'form-control','required')) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" placeholder="Password" autocomplete="off" value="" name="password" type="password" id="password" required>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group row">
                                <div class="col-md-10">
                                    ...
                                    {!! Form::hidden('is_created_by_admin',1, ['class' => 'form-control', 'required']) !!}
