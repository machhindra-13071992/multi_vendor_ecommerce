                        ...
                        <div class="chat-user-list scrollable">
                            <div class="chat-section">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-1.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-2.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-3.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-6.jpg'; ?>" alt="">
                                    <div class="user-info">
                            ...
                            <div class="chat-section">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-4.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-5.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-10.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-11.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <a href="javascript:void(0);" class="chat-user chat-toggle">
                                    <img class="thumb-img" src="<?php //echo url('/').'/resources/assets/images/avatars/thumb-9.jpg'; ?>" alt="">
                                    <div class="user-info">
                                ...
                                <div class="text-center mrg-top-20">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            <img class="img-fluid border-radius-round" src="<?php //echo url('/').'/resources/assets/images/avatars/user-1.jpg'; ?>" alt="">
                                        </div>
                                    </div>
