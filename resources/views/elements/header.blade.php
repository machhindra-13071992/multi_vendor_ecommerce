                        ...
                        <div class="search-wrapper">
                            <div class="pdd-vertical-10">
                                ...
                                <ul class="list-unstyled list-info">
                                    <li>
                                        <a href="">
                                            <img class="thumb-img" src="{{ secure_asset('/resources/assets/images/avatars/thumb-1.jpg') }}" alt="">
                                            <div class="info">
                                    ...
                                    <li>
                                        <a href="">
                                            <img class="thumb-img" src="{{ secure_asset('/resources/assets/images/avatars/thumb-5.jpg') }}" alt="">
                                            <div class="info">
                                    ...
                                    <li>
                                        <a href="">
                                            <img class="thumb-img" src="{{ secure_asset('/resources/assets/images/avatars/thumb-4.jpg') }}" alt="">
                                            <div class="info">
                            ...
                            <div class="pdd-vertical-10">
                                ...
                                <ul class="list-unstyled list-info">
                                    <li>
                                        <a href="">
                                            <img class="thumb-img" src="{{ secure_asset('/resources/assets/images/img-1.jpg') }}" alt="">
                                            <div class="info">
                                    ...
                                    <li>
                                        <a href="">
                                            <img class="thumb-img" src="{{ secure_asset('/resources/assets/images/img-2.jpg') }}" alt="">
                                            <div class="info">
            ...
            <ul class="nav-right">
                <li class="user-profile dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                        <img class="profile-img img-fluid" src="{{ secure_asset('resources/assets/images/user.png') }}" alt="">
                        <div class="user-info">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="" href="{{ secure_asset('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                <span><i class="ti-power-off pdd-right-10"></i>{{ __('Logout') }}</span>
                                <form id="logout-form" action="{{ secure_asset('logout') }}" method="POST" style="display: none;">@csrf </form>
                            </a>
                        </li>
                    </ul>
                </li>
