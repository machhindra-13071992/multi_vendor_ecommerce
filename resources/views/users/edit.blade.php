        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-heading border bottom">
                    <h4 class="card-title">User Edit Details</h4>
                </div>
                <div class="card-block">
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-12 ml-auto mr-auto">
                            {!! Form::model($users, ['id'=>'form-validation', 'novalidate'=>"novalidate",'method' => 'PATCH','route' => ['users.update', $users->id]]) !!}
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="row">
									<div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Password" autocomplete="off" value="{{ $users->password }}" name="password" type="password" id="password">
                                        </div>
                                    </div>
									<div class="col-md-3">
                                        <div class="form-group">
                                            {!! Form::Label('confirm_password', 'Confirm Password') !!}
											<input class="form-control" placeholder="Re-type Password" autocomplete="off" name="confirm_password" type="password" value="{{ $users->confirm_password }}" id="confirm_password">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
