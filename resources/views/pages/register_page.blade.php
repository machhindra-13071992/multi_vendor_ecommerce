                        ...
                        <div class="login_form_wrapper" style="border-left-width: 34px;margin-left: 206px;">
                            <div class="sv_heading_wraper heading_wrapper_dark dark_heading hwd">
                                ...
                                @if(Input::get('success'))
                                    ...
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <strong>Success!</strong> You have successfully registered <a href="{{ secure_asset('/login') }}">click here to login</a>
                                    </div>
                                @endif
                            </div>
                            {!! Form::open(['route' => 'user_register', 'method' => 'GET', 'role'=>'form', 'id'=>'form-validation', 'novalidate'=>"novalidate"]) !!}
                            ...
                            <div class="form-group icon_form comments_form">
                                <input name="password" type="password" class="form-control required" placeholder="Confirm Password *">
                                <!--{!! Form::password('password', null, ['class' => 'form-control', 'placeholder'=>'Password','type'=>'password','required']) !!}-->
                            </div>
                             <div class="form-group icon_form comments_form">
                                 {!! Form::text('mobile_no', null, ['class' => 'form-control require', 'data-parsley-type'=>"mobile", 'placeholder'=>'Mobile No', 'required']) !!}
                                <!--{!! Form::password('password', null, ['class' => 'form-control', 'placeholder'=>'Password','type'=>'password','required']) !!}-->
                            </div>
                            <div class="about_btn login_btn float_left">
                                <a href="Javascript:void(0)" onclick="registerProcess()">submit</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
