                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-12 ml-auto mr-auto">
                                {!! Form::model($cities, ['id'=>'form-validation', 'novalidate'=>"novalidate",'method' => 'PATCH','route' => ['cities.update', $cities->id]]) !!}
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('state_id',['' => 'Select'] + $states, null, ['class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
