...
<head>
    ...
    <script src="{{ secure_asset('resources/assets/js/jquery.blockUI.js') }}"></script>
    ...
    <script src="{{ secure_asset('resources/assets/js/easytimer.js') }}"></script>
    <script src="{{ secure_asset('resources/assets/js/custom-timer.js?v1.3') }}"></script>
    <!-- page plugins js -->
    ...
    <div class="app">
        <div class="layout">
            ...
            <div class="page-container">
                ...
                @include('elements.theme_configurator')
                ...
                <div class="main-content">
                    <div class="container-fluid">
                         <!-- Breadcrumb Panel START -->
                             @include('elements.breadcrumbs')
                        <!-- Breadcrumb Panel END -->
                        @yield('content')
                    </div>
                </div>
                <!-- Content Wrapper END -->
