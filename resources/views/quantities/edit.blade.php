                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-12 ml-auto mr-auto">
                                {!! Form::model($quantities, ['id'=>'form-validation','novalidate'=>"novalidate",'enctype'=>"multipart/form-data",'method' => 'PATCH','route' => ['quantities.update', $quantities->id]]) !!}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group required">
                                                {!! Form::Label('name', 'Category') !!}
                                                {!! Form::hidden('id', $quantities->id, [ ]); !!}
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<?php  if(!isset($quantities['image_file'])) {?>  <?php  } ?> >
											</div>
										</div>
										<div class="col-md-4">  
